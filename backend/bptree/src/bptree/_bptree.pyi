...
class BPTreeIntInt:
    ...
    def insert(self, _key: int, _val: int) -> None: ...
    def erase(self, _key: int) -> None: ...
    def update(self, _key: int, _new_val: int) -> bool: ...
    def find(self, _key: int) -> Optional[int]: ...
...
class BPTreeStrStr:
    def __init__(self, order: int) -> None: ...
    def insert(self, _key: str, _val: str) -> None: ...
    def erase(self, _key: str) -> None: ...
    def update(self, _key: str, _new_val: str) -> bool: ...
    def find(self, _key: str) -> Optional[str]: ...
    def deserialize(self, filename: str) -> None: ...
    def serialize(self, filename: str) -> None: ...
    def getAllKeys(self) -> List[str]: ...
    def getAllValues(self) -> List[str]: ...
