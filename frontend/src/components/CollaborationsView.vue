...
<template>
  <div>
    ...
    <div class="tabs tabs-boxed mb-6">
      <a
        class="tab"
        :class="{ 'tab-active': activeTab === 'networkGraph' }"
        @click="activeTab = 'networkGraph'"
        >Collaboration Network</a
      >
      <a
        class="tab"
        :class="{ 'tab-active': activeTab === 'cliques' }"
        @click="activeTab = 'cliques'"
        >Collaboration Cliques</a
      >
    </div>
    ...
    <div v-if="activeTab === 'networkGraph'" class="card bg-base-100 shadow-xl">
      <div class="card-body">
        ...
        <div v-else-if="collaborators" class="w-full h-96">
          <v-chart
            class="w-full h-full"
            :option="collaborationNetworkChartOptions"
            @click="handleCollaborationNetworkChartClick"
            autoresize
          />
        </div>
            ...
            <table class="table">
              ...
              <tbody>
                <tr v-for="article in coauthoredArticles" :key="article.article_id">
                  ...
                  <td>
                    <button class="btn btn-xs btn-ghost" @click="viewArticle(article.article_id)">
                      View
                    </button>
                  </td>
                </tr>
    ...
    <div v-if="activeTab === 'cliques'" class="card bg-base-100 shadow-xl">
      <div class="card-body">
        ...
        <p class="mb-4">
          This view shows fully connected subgraphs (cliques) of research collaborations. A k-clique
          represents a group where every author has collaborated with every other author in the
          group.
        </p>

        <!-- Progress Steps -->
        <ul class="steps w-full mb-6">
          <li class="step" :class="{ 'step-primary': CliqueStep >= 1 }">Initialize</li>
          <li class="step" :class="{ 'step-primary': CliqueStep >= 2 }">Build Adjacency List</li>
          <li class="step" :class="{ 'step-primary': CliqueStep >= 3 }">Run Pivoter Algorithm</li>
          <li class="step" :class="{ 'step-primary': CliqueStep >= 4 }">Complete</li>
        </ul>
        ...
        <div class="grid gap-4">
          ...
          <!-- Progress -->
          <div
            v-if="CliqueStep === 3 || CliqueStep === 1"
