...
<template>
  <div>
    ...
    <div class="tabs tabs-boxed mb-6">
      <a
        class="tab"
        :class="{ 'tab-active': activeTab === 'byAuthor' }"
        @click="activeTab = 'byAuthor'"
        >By Author</a
      >
      <a
        class="tab"
        :class="{ 'tab-active': activeTab === 'byTitle' }"
        @click="activeTab = 'byTitle'"
        >By Title</a
      >
      <a
        class="tab"
        :class="{ 'tab-active': activeTab === 'byKeywords' }"
        @click="activeTab = 'byKeywords'"
        >By Keywords</a
      >
    </div>
        ...
        <div class="form-control">
          ...
          <div class="flex gap-2">
            <input
              ...
              @keyup.enter="handleSearchByAuthorClick"
            />
            <button
              class="btn btn-primary"
              @click="handleSearchByAuthorClick"
              :disabled="isLoading"
            >
    ...
    <div v-if="activeTab === 'byTitle'" class="card bg-base-100 shadow-xl">
      <div class="card-body">
        ...
        <div class="form-control">
          ...
          <div class="flex gap-2">
            <input
              ...
              v-model="title"
              class="input input-bordered flex-1"
              @keyup.enter="handleSearchByTitleClick"
            />
        ...
        <div v-else-if="!titleResults" class="text-center py-4 text-gray-500">No results found</div>
          ...
          <div class="card bg-base-200">
            <div class="card-body">
              ...
              <div class="flex justify-end">
                <button
                  class="btn btn-neutral btn-secondary w-32"
                  @click="viewArticle(titleResults.article_id)"
                >
                  View Details
                </button>
              </div>
      ...
      <div class="card-body">
        ...
        <div class="form-control">
          ...
          <div class="flex gap-2">
            <input
              type="text"
              v-model="keywordsPattern"
              placeholder="Enter title keywords"
              class="input input-bordered flex-1"
              @keyup.enter="handleSearchByKeywordsClick"
            />
        ...
        <div v-else class="overflow-x-auto">
          ...
          <div v-if="keywordsResults.length > 0" class="mt-4 flex justify-center">
            <div class="flex join pagination-container">
              <button
                class="join-item btn pagination-prev"
              ...
              <div
                class="join-item overflow-x-auto max-w-[50vw] flex pagination-buttons-container"
              ...
              <button
                class="join-item btn pagination-next"
