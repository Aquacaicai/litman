...
const isFormValid = computed(() => {
  return article.value.title && article.value.authors.length > 0 && article.value.year
})
...
function handleImportLiteratureClick() {
  ...
  api.import
    .importFromXml(fileContent.value)
    .then((response) => {
...
<template>
  <div>
    ...
    <div class="tabs tabs-boxed mb-6">
      <a class="tab" :class="{ 'tab-active': activeTab === 'import' }" @click="activeTab = 'import'"
        >Import Literature</a
      >
      <a class="tab" :class="{ 'tab-active': activeTab === 'add' }" @click="activeTab = 'add'"
        >Add Manually</a
      >
    </div>
    ...
    <div v-if="activeTab === 'import'" class="card bg-base-100 shadow-xl">
      <div class="card-body">
        ...
        <div class="flex justify-end mt-4">
          <button class="btn btn-primary" @click="handleImportLiteratureClick">
            Import Literature
          </button>
        </div>
      </div>
      ...
      <div class="card-body">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          <div class="form-control">
            ...
            <input
              type="text"
              placeholder="For book chapters or proceedings"
              class="input input-bordered"
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          <div class="form-control">
            ...
            <input
              type="text"
              placeholder="For theses or technical reports"
              class="input input-bordered"
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div class="form-control">
            ...
            <input
              type="text"
              placeholder="Book/conference series"
              class="input input-bordered"
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          <div class="form-control">
            ...
            <input
              type="text"
              placeholder="DOI or electronic reference"
              class="input input-bordered"
              v-model="article.ee"
            />
          </div>
